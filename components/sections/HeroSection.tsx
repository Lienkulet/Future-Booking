  ...
  return (
    <section className="relative min-h-screen flex flex-col overflow-hidden pb-16">
      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-center text-center px-6 mt-32 pb-16">
        {/* Tagline Pill */}
        <FadeIn mount delay={0.2}>
          <div
            className="flex items-center gap-2 px-3 h-9.5 rounded-[10px] border mb-8"
            style={{
          ...
          >
            <span className="bg-[#7b39fc] text-white font-cabin font-medium text-[14px] px-2 py-0.5 rounded-md leading-none">
              New
            </span>
        ...
        {/* Subtext */}
        <FadeIn mount delay={0.5}>
          <p className="font-inter font-normal text-[18px] text-white/70 max-w-165.5 mb-10 leading-relaxed">
